...
public partial class GameEntity {
    ...
    public Code.Scenes.BattleScene.ECS.Components.Game.MaxSpeedComponent maxSpeed { get { return (Code.Scenes.BattleScene.ECS.Components.Game.MaxSpeedComponent)GetComponent(GameComponentsLookup.MaxSpeed); } }
    ...
    public void AddMaxSpeed(float newValue) {
        ...
        var component = (Code.Scenes.BattleScene.ECS.Components.Game.MaxSpeedComponent)CreateComponent(index, typeof(Code.Scenes.BattleScene.ECS.Components.Game.MaxSpeedComponent));
