...
public partial class LobbyUiEntity {
    ...
    public Code.Scenes.LobbyScene.ECS.Components.EnableWarshipImprovementModalWindowComponent enableWarshipImprovementModalWindow { get { return (Code.Scenes.LobbyScene.ECS.Components.EnableWarshipImprovementModalWindowComponent)GetComponent(LobbyUiComponentsLookup.EnableWarshipImprovementModalWindow); } }
    ...
    public void AddEnableWarshipImprovementModalWindow(NetworkLibrary.NetworkLibrary.Http.WarshipDto newWarshipDto) {
        ...
        var component = (Code.Scenes.LobbyScene.ECS.Components.EnableWarshipImprovementModalWindowComponent)CreateComponent(index, typeof(Code.Scenes.LobbyScene.ECS.Components.EnableWarshipImprovementModalWindowComponent));
